# Full dataset builder that processes all 66 pages of OCR and outputs TypeScript chunks
import json
import os
import re
...
# Helper function to categorize topic
def get_topic_for_num(n):
...
print("Ready to process all questions.")
