...
export const ReviewView: React.FC<ReviewViewProps> = ({
  ...
  return (
    <div id="review-view" className="w-full max-w-6xl mx-auto px-3 sm:px-6 py-8 min-w-0">
      {/* Header Section */}
      <div className="pb-6 mb-6 border-b border-outline-variant/30 min-w-0">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-4 min-w-0">
          <div className="min-w-0">
            ...
            <h1 className="text-2xl sm:text-3xl font-black text-on-surface tracking-tight break-words">
              Retention & Mistakes Review
            </h1>
            <p className="text-body-medium text-on-surface-variant font-medium mt-1 max-w-2xl break-words">
          ...
          <div className="flex flex-wrap items-center gap-2 shrink-0">
            {dueQuestionIds.length > 0 && (
              <button
                ...
                className="px-5 py-2.5 rounded-shape-full bg-primary hover:opacity-95 active:scale-95 text-on-primary font-black text-label-large uppercase tracking-wide shadow-xs flex items-center justify-center gap-2 transition-all"
              >
            ...
            {mistakes.length > 0 && (
              <button
                ...
                className="px-4 py-2.5 rounded-shape-full border border-outline-variant/30 bg-surface-container-high hover:bg-surface-container-highest active:scale-95 text-on-surface font-bold text-label-large flex items-center justify-center gap-2 transition-all shadow-xs"
            ...
            {mistakes.length > 0 && (
              <button
                ...
                className="p-2.5 rounded-shape-full border border-outline-variant/30 bg-surface-container text-on-surface-variant hover:text-error hover:bg-error-container/40 transition-colors"
            ...
            return (
              ...
              >
                <div className="flex-1 min-w-0">
                  ...
                  <h4 className="font-bold text-on-surface text-title-small leading-snug break-words">
                    {q.questionRu}
                  </h4>
                  {q.questionEn && (
                    <p className="text-body-small text-on-surface-variant mt-1 font-medium break-words">
                      {q.questionEn}
                    </p>
                  )}
                ...
                <div className="flex sm:flex-col items-center gap-2 self-end sm:self-center shrink-0">
                  <button
                    ...
                    className="px-3.5 py-1.5 rounded-shape-full bg-surface-container-highest hover:bg-primary hover:text-on-primary text-on-surface text-label-medium font-bold transition-colors flex items-center gap-1.5 shadow-xs"
                  >
